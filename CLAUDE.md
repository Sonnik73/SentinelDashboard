...
- Погода теперь получается скрейпингом десктопной версии rp5.ru (с v1.6.0 — Open-Meteo был недоступен из сети, а бесплатный тариф Yandex Weather API сократили до 14 дней триала). Парсинг проверен на реальном сохранённом HTML города Ульяновск; URL для Москвы и Краснодара в `config/dashboard.json` — непроверенные догадки по стандартному склонению, нужно свериться на боевом окружении. Как и с любым скрейпингом, парсинг может сломаться при редизайне rp5.ru — см. `docs/MODULES.md`.
